...
import (
	...
	common "jetoffloader/jnx/jet/common"
	reflect "reflect"
	sync "sync"
)
...
var file_jnx_management_service_proto_rawDesc = []byte{
	...
	0x6e, 0x78, 0x2e, 0x6a, 0x65, 0x74, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e,
	0x74, 0x2e, 0x45, 0x70, 0x68, 0x65, 0x6d, 0x65, 0x72, 0x61, 0x6c, 0x43, 0x6f, 0x6e, 0x66, 0x69,
	0x67, 0x53, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x2c,
	0x5a, 0x19, 0x6a, 0x65, 0x74, 0x6f, 0x66, 0x66, 0x6c, 0x6f, 0x61, 0x64, 0x65, 0x72, 0x2f, 0x6a,
	0x6e, 0x78, 0x2f, 0x6a, 0x65, 0x74, 0x2f, 0x6d, 0x67, 0x6d, 0x74, 0x82, 0xb5, 0x18, 0x05, 0x30,
	0x2e, 0x30, 0x2e, 0x30, 0x8a, 0xb5, 0x18, 0x04, 0x31, 0x38, 0x2e, 0x34, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
func (c *managementClient) OpCommandGet(ctx context.Context, in *OpCommandGetRequest, opts ...grpc.CallOption) (Management_OpCommandGetClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Management_serviceDesc.Streams[0], "/jnx.jet.management.Management/OpCommandGet", opts...)
	if err != nil {
		return nil, err
	}
